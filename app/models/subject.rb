class Subject < ApplicationRecord
  ...
  has_many :subcategories, class_name: "Subject", foreign_key: "parent_id", dependent: :destroy
  belongs_to :parent, class_name: "Subject", foreign_key: "parent_id", optional: true
