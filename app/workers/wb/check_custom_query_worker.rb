module Wb
  class CheckCustomQueryWorker
    ...
    def perform
      cosmetics = ['Бальзам для губ', 'Твердый бальзам для волос', 'Крем для рук и тела', 'Твердое масло для тела' ]
      ...
      queries = cosmetics +  clothes + gifts
      ...
      queries.each do |name|
       ...
       ::Wb::CheckDiscountsWorker.perform_async('кроссовки женские', 'женщины', [1], 50)
    end
  end
end
